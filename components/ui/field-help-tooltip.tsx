...
export function FieldHelpTooltip({
  ...
  return (
    <span className="group/tooltip relative inline-flex items-center">
      ...
      <span
        className="pointer-events-none absolute left-0 top-full z-20 mt-2 w-60 rounded-md border border-border bg-card px-2.5 py-2 text-xs leading-5 text-card-foreground opacity-0 shadow-md transition-opacity group-focus-within/tooltip:opacity-100 group-hover/tooltip:opacity-100"
        id={tooltipId}
        role="tooltip"
      >
        {content}
